...
const About = () => {
  return (
    <section
      id="about"
      className="relative section-padding overflow-hidden bg-[#080812]"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <h3 className="text-2xl font-bold font-display text-white">
              Building with <span className="gradient-text">depth</span> and
              precision
            </h3>

            <p className="text-slate-400 leading-relaxed">
              I&apos;m a dedicated Full Stack Developer with{" "}
              <span className="text-white font-medium">1+ year</span> of
              building production-ready software, spanning from multi-role
              publishing platforms to AI-powered detection systems. I work
              across the entire stack so I can own features end-to-end.
            </p>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              . I&apos;ve also shipped a Flutter mobile app with on-device ML
              and a scikit-learn disease prediction model, because good
              engineers aren&apos;t afraid to go beyond their comfort zone.
            </p>

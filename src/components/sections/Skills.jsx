...
const categoryColorMap = {
  purple: {
    ...
    badge:
      "hover:bg-purple-500/15 hover:border-purple-500/30 hover:text-purple-200 hover:shadow-[0_0_12px_rgba(168,85,247,0.2)]",
  },
  cyan: {
    ...
    badge:
      "hover:bg-cyan-500/15 hover:border-cyan-500/30 hover:text-cyan-200 hover:shadow-[0_0_12px_rgba(6,182,212,0.2)]",
  },
  emerald: {
    ...
    badge:
      "hover:bg-emerald-500/15 hover:border-emerald-500/30 hover:text-emerald-200 hover:shadow-[0_0_12px_rgba(16,185,129,0.2)]",
  },
  blue: {
    ...
    badge:
      "hover:bg-blue-500/15 hover:border-blue-500/30 hover:text-blue-200 hover:shadow-[0_0_12px_rgba(59,130,246,0.2)]",
  },
  pink: {
    ...
    badge:
      "hover:bg-pink-500/15 hover:border-pink-500/30 hover:text-pink-200 hover:shadow-[0_0_12px_rgba(236,72,153,0.2)]",
  },
};
...
const SkillCard = ({ skill, categoryColor, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-12 h-12 rounded-xl border flex items-center justify-center mb-4 ${cm.icon}`}
      >
        <skill.icon
...
SkillCard.propTypes = {
  ...
  categoryColor: PropTypes.oneOf(["purple", "cyan", "emerald", "blue", "pink"])
    .isRequired,

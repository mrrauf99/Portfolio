                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label
                        ...
                        className="text-sm text-slate-400 font-display"
                      >
                        Name
                      </label>
                      <input
                        ...
                        className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none font-sans ${
                          errors.name
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-white/5 border rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none resize-none font-sans ${
                        errors.message
                          ? "border-red-500/30 focus:border-red-500/50 focus:bg-red-500/5"
                          : "border-white/10 focus:border-purple-500/50 focus:bg-purple-500/5"
                      }`}

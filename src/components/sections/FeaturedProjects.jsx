...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br ${cm.gradient} opacity-50`}
        aria-hidden="true"
      />

      <div className="absolute top-4 right-4 z-10">
        <div
          className={`flex items-center gap-1 px-2 py-1 rounded-full border ${cm.tag} text-xs font-display font-semibold`}
        >
      ...
      <div className="relative z-10 grid md:grid-cols-2 gap-0">
        <div className="p-8 md:p-10 flex flex-col justify-between">
          <div>
            ...
            <p className="text-slate-400 leading-relaxed mb-6 text-sm line-clamp-3 md:line-clamp-none">
              {project.description}
            </p>
...
ProjectInfoPanel.propTypes = {
  ...
  cm: PropTypes.shape({
    ...
    statBg: PropTypes.string.isRequired,
    archBg: PropTypes.string.isRequired,
  }).isRequired,
